...
- [ ] **Step 2: Run the tests and verify they fail because task persistence is absent**
...
- [ ] **Step 3: Add normalized SQLite migrations and task CRUD**
...
- [ ] **Step 4: Run store and orchestrator tests**
...
- [ ] **Step 5: Commit the durable local store**
...
- [ ] **Step 2: Verify tests fail before the local worker exists**

Run: `go test ./internal/localapp -v`

Expected: FAIL because the package and `App` execution worker are absent.

- [ ] **Step 3: Implement a single bounded local queue**
...
- [ ] **Step 4: Remove cloud publication from the runner path and wire telemetry in memory**
...
- [ ] **Step 4: Compose the one-process Local Agent**
...
- [ ] **Step 5: Update laptop services and local configuration**
...
- [ ] **Step 6: Run API, command, and service contract tests**
...
- [ ] **Step 7: Commit the one-process desktop product**
...
- [ ] **Step 2: Run contract tests and verify old services cause failure**
...
- [ ] **Step 3: Update the protobuf schema and regenerate bindings**
...
- [ ] **Step 4: Update semantic mapping and compatibility checks**
...
- [ ] **Step 5: Update Python runtime and all protocol clients**
...
- [ ] **Step 6: Run generation, Go, Python, and contract tests**
...
- [ ] **Step 1: Write failing journal and restart tests**
...
- [ ] **Step 2: Verify journal tests fail because state is only in memory**
...
- [ ] **Step 3: Implement an atomic bounded JSON journal**
...
- [ ] **Step 4: Integrate journal state into service and safety**
...
- [ ] **Step 5: Remove Raspberry Pi policy-provider execution**
...
- [ ] **Step 6: Run safety, backend, and deployment tests**
...
- [ ] **Step 7: Commit Pi safety persistence**
...
- [ ] **Step 1: Write failing role and dependency tests**
...
- [ ] **Step 2: Verify installer tests fail on the four-role topology**
...
- [ ] **Step 3: Remove cloud installation and make direct Pi runtime the default**
...
- [ ] **Step 4: Build only product binaries**
...
- [ ] **Step 5: Run installation and CLI tests**
...
- [ ] **Step 6: Commit installation simplification**
...
- [ ] **Step 1: Write failing API and static-asset contract tests**
...
- [ ] **Step 2: Run tests and verify missing first-run configuration**
...
- [ ] **Step 3: Add local settings and runtime cards**
...
- [ ] **Step 4: Use one global local event connection**
...
- [ ] **Step 5: Run Console and API tests**
...
- [ ] **Step 6: Commit the local Console**
...
- [ ] **Step 1: Write failing repository architecture tests**
...
- [ ] **Step 2: Verify architecture tests fail while obsolete runtime remains**
...
- [ ] **Step 3: Move reusable code to responsibility-based packages**
...
- [ ] **Step 4: Remove PostgreSQL dependencies and tidy modules**
...
- [ ] **Step 5: Rewrite current docs and mark historical cloud docs as superseded**
...
- [ ] **Step 7: Run simulation acceptance**
...
- [ ] **Step 8: Commit the completed local-first architecture**
