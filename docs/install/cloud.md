...
> **状态：已于 2026-08-18 被本地优先架构取代。** 本文保留用于追溯旧版本部署和迁移决策，不再是可执行安装指南。新安装请使用[笔记本 Local Agent 指南](local.md)，架构依据见[本地优先设计规范](../superpowers/specs/2026-08-18-local-first-runtime-design.md)。旧 `cloud` 安装角色只返回迁移提示。
